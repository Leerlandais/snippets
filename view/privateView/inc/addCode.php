        ...
        <div class="grid grid-cols-4 gap-6">
            ...
            <div class="group pb-24 relative overflow-hidden">
                <form action="./" method="POST" class="border border-black px-8 text-center">
                    <h3 class="text-xl font-bold text-center pb-2">Add PHP Function</h3>
                    <div>
                    ...
                    <div>
                        <h3 class="text-xl font-bold text-center pb-2 pt-8">Add PHP Call</h3>
                    ...
                    <div class="flex flex-col">
                        ...
                        <select x-cloak name="addCodePhpTarget">
                            <option value="0">FreeStanding</option>
                            <?php
